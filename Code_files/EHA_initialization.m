...
J = 0.205;         % CHANGE UNITS !!!! Rotor Inertia [kg*m^2]
R = 138000/(370^2);         % Armature Resistance [Ohm]
...
C_fv =  100;      % Viscous Friction Coefficient [N*s/m] Leaving this for now. Might have to be changed later

%Leakage (with internal leakage on)
Clearance = 1e-4;  %Piston Cylinder Clearance  [m]
L_head   = 0.01;   %Piston Head Length  [m]

% The simulation MUST start with 0 deflection
...
P_set = 23.8;           % Set Pressure Differential [MPa]  <-- CHANGE FROM DEFAULT IMMEDIATELY
...
Mass = 1.205e+04;    %[kg] Force generated by the stabilator mass
